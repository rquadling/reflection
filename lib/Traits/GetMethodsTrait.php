...
namespace RQuadling\Reflection\Traits;
...
{
    /**
     * Override the standard ReflectionClass/ReflectionObject::getMethods method to return a custom ReflectionMethod array.
     *
     ...
     *
     * @return ReflectionMethod[] a filtered list of methods for the reflected class/object
     *
